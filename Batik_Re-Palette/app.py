...
def bangun_antarmuka():
    ...
    with gr.Blocks(title="Aplikasi Pewarnaan Batik") as aplikasi:
        ...
        with gr.Tabs():
            ...
            # ----------------------------------------------------------------
            # TAB 3 — CULTURAL FUSION (2 BUDAYA)
            # ----------------------------------------------------------------
            # Layout:
            #   [ Kiri: input 2 budaya + tema ] [ Tengah: template fusion ]
            #   [ Pojok Kanan: simulasi menjadi pakaian ]
            # ----------------------------------------------------------------
            with gr.Tab("[FUSION] Cultural Fusion (2 Budaya)"):
                gr.Markdown(
